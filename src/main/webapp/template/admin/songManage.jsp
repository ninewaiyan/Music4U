...
<body>
	...
	<div class="navbar">
		...
		<form action="admin" class="d-flex" method="get">
			<input type="hidden" name="mode" value="SEARCHSONG"> <input
	...
	<div class="container-fluid">
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
				...
				<h2 class="mb-4 mt-5">Song Management</h2>
				<div class="mt-4 mb-4">
						...
						<c:forEach var="song" items="${songs}">
							<tr>
								...
								<td><a class="btn btn-danger" data-bs-toggle="modal"
									data-bs-target="#deleteModal${song.id}">DELETE</a>
								<td>
							</tr>
						</c:forEach>
					</tbody>
			...
			aria-labelledby="deleteModalLabel${song.id}" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="deleteModalLabel${song.id}">Confirm
							Delete</h5>
					...
					<c:url var="deleteLink" value="admin">
						<c:param name="mode" value="DELSONG" />
