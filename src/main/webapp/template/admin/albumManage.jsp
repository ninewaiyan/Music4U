...
<body>
	...
	<div class="navbar">
		...
		<form action="admin" class="d-flex" method="get">
			<input type="hidden" name="mode" value="SEARCHALBUM"> <input
				type="text" placeholder="Search..." name="query" value="${query }">

			<button class="btn" type="submit">
				<img class="search"
					src="${pageContext.request.contextPath}/template/views/icons/search2.png">
			</button>
		</form>
		...
		<div class="row">
			...
			<nav class="sidebar d-flex flex-column">
				...
				<ul class="nav flex-column px-3">
					...
					<li class="nav-item"><a class="nav-link " href="artist"><i
							class="fas fa-users"></i>Add Artist</a></li>
					<li class="nav-item"><a class="nav-link" href="album"><i
							class="fas fa-music"></i>Add Album</a></li>
					<li class="nav-item"><a class="nav-link" href="song"><i
							class="fas fa-compact-disc"></i>Add Songs</a></li>
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
				<h2 class="mb-4 mt-5">Album Management</h2>
				<div class="mt-4 mb-4">
				...
				<table class="table table-striped">
					...
					<tbody>
						<c:forEach var="album" items="${albums}">
							<tr>
								<td>${album.id}</td>
								<td><img src="${pageContext.request.contextPath}/template/album/album_img/${album.image}">${album.name}</td>
								<th>${album.artistName }</th>
								<td><a class="btn btn-danger" data-bs-toggle="modal"
									data-bs-target="#deleteModal${album.id}">DELETE</a>
								<td>
							</tr>
						</c:forEach>
					</tbody>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<c:url var="deleteLink" value="admin">
								<c:param name="mode" value="DELALBUM" />
